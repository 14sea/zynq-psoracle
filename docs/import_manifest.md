...
| `docs/status.md` |
| `host/run_tests.sh` |
| `evidence/tests/test_report_2026-09-05T071345Z.json` |
| `evidence/tests/test_report_2026-09-05T063709Z.json` |
| `evidence/tests/test_report_2026-09-04T070318Z.json` |
| `evidence/tests/test_report_2026-09-04T064539Z.json` |
| `evidence/tests/test_report_2026-09-03T192114Z.json` |
| `evidence/tests/test_report_2026-09-03T191114Z.json` |
| `evidence/tests/test_report_2026-09-03T190345Z.json` |
| `evidence/tests/test_report_2026-09-03T190303Z.json` |
| `evidence/tests/test_report_2026-09-03T190229Z.json` |
| `evidence/tests/test_report_2026-09-03T185729Z.json` |
| `evidence/tests/test_report_2026-09-03T185649Z.json` |
| `evidence/tests/test_report_2026-09-03T184345Z.json` |
| `evidence/tests/test_report_2026-09-03T184325Z.json` |
...
| `evidence/tests/test_report_2026-09-03T170536Z.json` |
| `evidence/tests/test_report_2026-09-03T165710Z.json` |
| `evidence/tests/test_report_2026-09-03T165617Z.json` |
| `evidence/tests/test_report_2026-09-03T164546Z.json` |
| `evidence/tests/test_report_2026-09-03T150348Z.json` |
| `evidence/tests/test_report_2026-09-03T145716Z.json` |
| `evidence/tests/test_report_2026-09-03T142636Z.json` |
| `evidence/tests/test_report_2026-09-03T142624Z.json` |
| `evidence/tests/test_report_2026-09-03T142352Z.json` |
...
| `evidence/boundary/principal_boundary_2026-09-03-01.json` |
| `evidence/l6_17A6_2026-09-03-01-C1/L6_0_preflight.json` |
| `evidence/l6_17A6_2026-09-03-01-C1/L6_1_identity_page.json` |
| `evidence/l6_17A6_2026-09-03-01-C1/audits.json` |
| `evidence/l6_17A6_2026-09-03-01-C1/console.log` |
| `evidence/l6_17A6_2026-09-03-01-C1/console.ts.log` |
| `evidence/l6_17A6_2026-09-03-01-C1/rate_report.json` |
| `evidence/l6_17A6_2026-09-03-01-C1/run_log.json` |
| `evidence/l6_17A6_2026-09-03-01-C1/summary.json` |
| `evidence/l6_17A6_2026-09-03-01-C1/timeline.json` |
| `evidence/l6_17A6_2026-09-03-01-C1/ymodem.log` |
| `evidence/l6_17A6_2026-09-03-01-C1/ymodem_app.log` |
| `docs/l6_c1_session6_findings.md` |
| `evidence/boundary/principal_boundary_2026-09-03-02.json` |
| `evidence/l6_17A6_2026-09-03-02-C2/L6_0_preflight.json` |
| `evidence/l6_17A6_2026-09-03-02-C2/L6_1_identity_page.json` |
| `evidence/l6_17A6_2026-09-03-02-C2/audits.json` |
| `evidence/l6_17A6_2026-09-03-02-C2/console.log` |
| `evidence/l6_17A6_2026-09-03-02-C2/console.ts.log` |
| `evidence/l6_17A6_2026-09-03-02-C2/rate_report.json` |
| `evidence/l6_17A6_2026-09-03-02-C2/run_log.json` |
| `evidence/l6_17A6_2026-09-03-02-C2/summary.json` |
| `evidence/l6_17A6_2026-09-03-02-C2/timeline.json` |
| `evidence/l6_17A6_2026-09-03-02-C2/ymodem.log` |
| `evidence/l6_17A6_2026-09-03-02-C2/ymodem_app.log` |
| `docs/l6_c2_session2_findings.md` |
| `evidence/boundary/principal_boundary_2026-09-03-03.json` |
| `evidence/l6_17A6_2026-09-03-03-S/L6_0_preflight.json` |
| `evidence/l6_17A6_2026-09-03-03-S/L6_1_identity_page.json` |
| `evidence/l6_17A6_2026-09-03-03-S/audits.json` |
| `evidence/l6_17A6_2026-09-03-03-S/console.log` |
| `evidence/l6_17A6_2026-09-03-03-S/console.ts.log` |
| `evidence/l6_17A6_2026-09-03-03-S/run_log.json` |
| `evidence/l6_17A6_2026-09-03-03-S/summary.json` |
| `evidence/l6_17A6_2026-09-03-03-S/timeline.json` |
...
| `evidence/boundary/principal_boundary_2026-09-04-01.json` |
| `evidence/l6_17A6_2026-09-04-01-S/L6_0_preflight.json` |
| `evidence/l6_17A6_2026-09-04-01-S/L6_1_identity_page.json` |
| `evidence/l6_17A6_2026-09-04-01-S/audits.json` |
| `evidence/l6_17A6_2026-09-04-01-S/console.log` |
| `evidence/l6_17A6_2026-09-04-01-S/console.ts.log` |
| `evidence/l6_17A6_2026-09-04-01-S/rate_report.json` |
| `evidence/l6_17A6_2026-09-04-01-S/run_log.json` |
| `evidence/l6_17A6_2026-09-04-01-S/summary.json` |
| `evidence/l6_17A6_2026-09-04-01-S/timeline.json` |
| `evidence/l6_17A6_2026-09-04-01-S/ymodem.log` |
| `evidence/l6_17A6_2026-09-04-01-S/ymodem_app.log` |
| `evidence/l6_v07_counterfactual/s_2026-09-04-01_policy_replay.json` |
| `docs/l6_s_session3_findings.md` |
...
| `evidence/l6_next_build/build_evidence_734d6c04.json` |
| `evidence/l6_next_build/p3_app_l6_734d6c04.map` |
| `evidence/l6_build/build_evidence_e19e1b12.json` |
| `evidence/l6_build/p3_app_l6_e19e1b12.map` |
| `evidence/l6_build/build_evidence_403f4ab5.json` |
| `evidence/l6_build/p3_app_l6_403f4ab5.map` |
