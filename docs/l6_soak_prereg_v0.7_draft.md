...
| **S** soak, A,B,B,A schedule | rel-v4 two-operator | ⌊0.9 × min(rate_A, rate_B) × T⌋ under the rule the manifest NAMES (`sessions.S.n_rule`, D-n1), rates from the C1/C2 record hashes, bindings and input files (imported per D-i1) | sampled per §3a | D-s1 | armed | Q2 | `P3-L6` + `P3-K` |
